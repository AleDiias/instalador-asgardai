...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do AsgardAI que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador AsgardAI, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar AsgardAI\n"
  printf "   [1] Atualizar AsgardAI\n"
  printf "   [2] Deletar AsgardAI\n"
  printf "   [3] Bloquear AsgardAI\n"
  printf "   [4] Desbloquear AsgardAI\n"
  printf "   [5] Alter. dominio AsgardAI\n"
  printf "\n"
  read -p "> " option
